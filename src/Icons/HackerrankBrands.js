...
const SvgHackerrankBrands = props => (
  <svg
    aria-hidden="true"
    data-prefix="fab"
    data-icon="hackerrank"
    className="hackerrank-brands_svg__svg-inline--fa hackerrank-brands_svg__fa-hackerrank hackerrank-brands_svg__fa-w-16"
    viewBox="0 0 512 512"
    {...props}
  >
    <path
...
SvgHackerrankBrands.defaultProps = {
  fill: "currentColor"
}

SvgHackerrankBrands.prototype = {
  fill: PropTypes.string,
}


export default SvgHackerrankBrands;